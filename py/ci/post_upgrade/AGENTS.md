...
Compare auto-integrity archive URLs against `origin/main` before fetching: unchanged
archives must not block unrelated updates, while bot-branch retries must still
