...
language: en-GB
description: Disclosure of a severe bug allowing client-side takeover of Apple's central Apple ID server.
tags:
    - security
    - disclosure
    - writing
...
19. *Thursday, April 2nd 2020*
    - Ask if this is being considered as a generic XSS (the [Apple Bug Bounty][Apple Bug Bounty Payouts] page quotes a $25,000 payout for "limited unauthorized control of an iCloud account" and $100,000 for "Broad unauthorized control of an iCloud account.")
...
[Apple Bug Bounty Payouts]: https://web.archive.org/web/20200104173530/https://developer.apple.com/security-bounty/
