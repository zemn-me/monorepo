...
<img src={world_before_cors.src} alt="some cavemen attempt to make fire"/>
...
<img src={web_origin_concept.src} alt="the web origin concept"/>
...
<img src={non_cors_request_flow.src} alt="diagram: how a non-CORS request works"/>
...
<img alt="diagram: a CORS request flow on the web" src={cors_request_flow_on_the_web.src}/>
...
<img alt="picture: no gods, no masters (from 'fallout: new vegas')" src={no_gods_no_masters.src} />
