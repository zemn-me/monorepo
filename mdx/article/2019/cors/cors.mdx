...
import {
    corsRequestFlowOnTheWeb,
    noGodsNoMasters,
    nonCorsRequestFlow,
    webOriginConcept,
    worldBeforeCors,
} from '#root/mdx/article/2019/cors/sources.js';
...
<img src={worldBeforeCors} alt="some cavemen attempt to make fire"/>
...
<img src={webOriginConcept} alt="the web origin concept"/>
...
<img src={nonCorsRequestFlow} alt="diagram: how a non-CORS request works"/>
...
<img alt="diagram: a CORS request flow on the web" src={corsRequestFlowOnTheWeb}/>
...
<img alt="picture: no gods, no masters (from 'fallout: new vegas')" src={noGodsNoMasters} />
