...
def fetch_dependencies():
    ...
    http_archive(
        ...
        urls = [
            "https://github.com/protocolbuffers/protobuf/archive/v28.0.tar.gz",
        ],
    )
...
""",
    ...
    http_archive(
        ...
        urls = [
            "https://github.com/pulumi/pulumi/releases/download/v3.131.0/pulumi-v3.131.0-darwin-arm64.tar.gz",
        ],
