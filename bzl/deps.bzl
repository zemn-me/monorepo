...
def fetch_dependencies():
    ...
    http_archive(
        ...
        urls = [
            "https://github.com/pulumi/pulumi/releases/download/v3.74.0/pulumi-v3.74.0-linux-x64.tar.gz",
        ],
        build_file_content = """
exports_files(glob(["**/*"]))
""",
    ...
    http_archive(
        ...
        urls = [
            "https://github.com/pulumi/pulumi/releases/download/v3.74.0/pulumi-v3.74.0-darwin-arm64.tar.gz",
        ],
...
""",
    ...
    http_archive(
        ...
        urls = [
            "https://github.com/pulumi/pulumi/releases/download/v3.74.0/pulumi-v3.74.0-linux-arm64.tar.gz",
        ],
...
exports_files(glob(["**/*"], exclude_directories=0))
    ...
    http_archive(
        ...
        sha256 = "e1804701efbc8c4e438b241fa3988e59582b24c5305bac2e8d967be5b26b2e37",
        strip_prefix = "rules_js-1.29.1",
        url = "https://github.com/aspect-build/rules_js/releases/download/v1.29.1/rules_js-v1.29.1.tar.gz",
    )
