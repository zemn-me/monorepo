...
def fetch_dependencies():
    http_archive(
        ...
        url = "https://github.com/bazelbuild/rules_go/releases/download/v0.47.0/rules_go-v0.47.0.zip",
    )
    ...
    http_archive(
        ...
        urls = [
            "https://github.com/pulumi/pulumi/releases/download/v3.115.1/pulumi-v3.115.1-linux-x64.tar.gz",
        ],
        build_file_content = """
exports_files(glob(["**/*"]))
""",
    ...
    http_archive(
        ...
        urls = [
            "https://github.com/pulumi/pulumi/releases/download/v3.115.1/pulumi-v3.115.1-darwin-arm64.tar.gz",
        ],
...
""",
    ...
    http_archive(
        ...
        urls = [
            "https://github.com/pulumi/pulumi/releases/download/v3.115.1/pulumi-v3.115.1-linux-arm64.tar.gz",
        ],
...
exports_files(glob(["**/*"], exclude_directories=0))
    ...
    http_archive(
        ...
        url = "https://github.com/microsoft/json-schemas/archive/458efce7609ca4faacbbd8617b5ecb7e35fa229d.zip",
        strip_prefix = "json-schemas-458efce7609ca4faacbbd8617b5ecb7e35fa229d",
        build_file_content = """
exports_files(glob(["**/*"]))
        """,
        sha256 = "58f5234fe5421490bb9d6853cf8dea2ca3415738e60f16b0968f2f3c2bb31652",
    )
