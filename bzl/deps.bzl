...
def fetch_dependencies():
    ...
    http_archive(
        ...
        urls = [
            "https://github.com/protocolbuffers/protobuf/archive/v3.21.6.tar.gz",
        ],
    )
    ...
    http_archive(
        ...
        urls = [
            "https://github.com/pulumi/pulumi/releases/download/v3.40.0/pulumi-v3.40.0-linux-x64.tar.gz",
        ],
        build_file_content = """
exports_files(glob(["**/*"]))
        """,
