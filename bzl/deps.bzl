...
def fetch_dependencies():
    ...
    http_archive(
        ...
        url = "https://github.com/bazelbuild/rules_go/releases/download/v0.45.0/rules_go-v0.45.0.zip"
    )
    ...
    http_archive(
        ...
        urls = [
            "https://github.com/pulumi/pulumi/releases/download/v3.102.0/pulumi-v3.102.0-linux-x64.tar.gz",
        ],
        build_file_content = """
exports_files(glob(["**/*"]))
""",
    ...
    http_archive(
        ...
        urls = [
            "https://github.com/pulumi/pulumi/releases/download/v3.102.0/pulumi-v3.102.0-darwin-arm64.tar.gz",
        ],
...
""",
    ...
    http_archive(
        ...
        urls = [
            "https://github.com/pulumi/pulumi/releases/download/v3.102.0/pulumi-v3.102.0-linux-arm64.tar.gz",
        ],
...
exports_files(glob(["**/*"], exclude_directories=0))
    ...
    http_archive(
        ...
        url = "https://github.com/microsoft/json-schemas/archive/1451a8e79f0e481e20a56e195c461cdfe5e2aee8.zip",
        strip_prefix = "json-schemas-1451a8e79f0e481e20a56e195c461cdfe5e2aee8",
        build_file_content = """
exports_files(glob(["**/*"]))
        """,
        sha256 = "1989f602926aa06d552e9aa8bd5866e9f452130bfb16fe0842bf35ad7aaddb2c",
    )
