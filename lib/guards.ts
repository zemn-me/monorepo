import { TypeOfError, GuardFailedError } from './errors';

export function must<T, O extends T, A extends unknown[]>
    (t: (v: T, ...a: A) => v is O, v: T, ...a: A): asserts v is O {
...
export function isOneOf<T>(v: unknown, a: readonly T[], name?: string): v is T {
...
export function all<I1, O1 extends I1, O2 extends O1, A extends unknown[]>(
    ...
    return Object.defineProperty((v: I1, ...arg: A): v is O2 => {
...
export function alli<I,  O1 extends I, O2 extends I, A extends unknown[]>(
    ...
    return Object.assign((v: I, ...arg: A): v is O1 & O2 => {
        if (!a(v, ...arg)) return false;
        return b(v, ...arg);
    }, { get name(){ return `all(${[a,b].map(({ name }) => name ).join(", ")})` } });
}
...
export function hasMember<
    ...
    I, O extends I, args extends unknown[]
    >(
    k: K,
...
export function isUndefined(v: unknown, name?: string): v is undefined {
