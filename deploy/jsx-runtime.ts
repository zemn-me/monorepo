...
export class Artifact extends Tag<{ readonly name: string, readonly tag: string}, never> {
    toArtifact(): Artifact{ return this }
}

export class NpmPackage extends Tag<{ readonly package_json: string, readonly uploadScript: string }> {
    run() {
...
export function jsx(): 1 { return 1 }
