module github.com/zemn-me/monorepo/tests

go 1.21

replace github.com/zemn-me/monorepo/provider => ../provider

require (
	github.com/blang/semver v3.5.1+incompatible
	github.com/pulumi/pulumi-go-provider v0.11.1
	github.com/pulumi/pulumi-go-provider/integration v0.10.0
	github.com/zemn-me/monorepo/provider v0.0.0-00010101000000-000000000000
