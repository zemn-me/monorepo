...
import (
	...
	crane "github.com/zemn-me/monorepo/go/terraform/crane/provider"

	"github.com/zemn-me/monorepo/go/terraform/crane/version"
)
...
const (
	...
	mainPkg = "crane"
	// modules:
	mainMod = "index" // the crane module
)

//go:embed cmd/pulumi-resource-crane/bridge-metadata.json
var metadata []byte
...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		//
		//    - In provider/cmd/pulumi-tfgen-crane/main.go, replace the
		...
		//
		//    - In provider/cmd/pulumi-resource-crane/main.go, replace the
		...
		//
		//      	tfbridge.Main(context.Background(), "crane", xyz.Provider(),
		...
		// convention is to have a function at "github.com/iwahbe/terraform-provider-crane/provider".New
		...
		//
		//nolint:lll
		P: shimv2.NewProvider(crane.New(version.Version)()),
		...
		PluginDownloadURL: "",
		Description:       "A Pulumi package for creating and managing crane cloud resources.",
		// category/cloud tag helps with categorizing the package in the Pulumi Registry.
		// For all available categories, see `Keywords` in
		// https://www.pulumi.com/docs/guides/pulumi-packages/schema/#package.
		Keywords:   []string{"crane", "category/cloud"},
		License:    "Apache-2.0",
		Homepage:   "https://www.pulumi.com",
		Repository: "https://github.com/pulumi/pulumi-crane",
		...
		Golang: &tfbridge.GolangInfo{
			...
			ImportBasePath: path.Join(
				"github.com/pulumi/pulumi-crane/sdk/",
	...
	prov.MustComputeTokens(tokens.SingleModule("crane_", mainMod,
