...
export const inShort = "An epic essay disclosing a bug that allowed client-side takeover of Apple's central AppleID server";
export const title = "How To hack iCloud";
export const tags = ["security", "disclosure"];
