export const date = new Date("Thu Feb 16 2017 01:38:03 GMT+0000 (Greenwich Mean Time)")
export const medium = new URL("https://medium.com/@Zemnmez/design-evolves-by-constraint-f2d87697d25e")
export const title = "Design Evolves by Constraint";
export const inShort = "Some quick musings on how a medium's restriction allow design to flourish"
export const tags = ["design"];
