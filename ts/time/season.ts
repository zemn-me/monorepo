...
export const winter = Symbol('winter'),
...
export function getSeason(
	...
	isNorthernHemi: boolean = isNorthernHemisphere(timeZone)
): Season {
	const seasons = ([southernSeasons, northernSeasons] as const)[
		+isNorthernHemi as 0 | 1
	];
