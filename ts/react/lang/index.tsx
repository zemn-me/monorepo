...
export class TextType<L extends Language = Language, Text = string> {
	constructor(public readonly language: L, public readonly text: Text) {}
}

export type Text<L extends Language = Language, Text = string> = TextType<L, Text>;

export function Text<L extends Language = Language, Text = string>(language: L, text: Text): TextType<L, Text> {
