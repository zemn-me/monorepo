 ...
 */
export type TaggedText<C extends  string | number | React.ReactElement<any, string | React.JSXElementConstructor<any>> =  string | number | React.ReactElement<any, string | React.JSXElementConstructor<any>>> =
	readonly [Lang, C];
 ...
 */
export type Text<C extends  string | number | React.ReactElement<any, string | React.JSXElementConstructor<any>> =  string | number | React.ReactElement<any, string | React.JSXElementConstructor<any>>> = TaggedText<C>;
...
export function get<C extends  string | number | React.ReactElement<any, string | React.JSXElementConstructor<any>> =  string | number | React.ReactElement<any, string | React.JSXElementConstructor<any>>>(t: Text<C>): string {
	return t[0]
}

export function text<C extends  string | number | React.ReactElement<any, string | React.JSXElementConstructor<any>> =  string | number | React.ReactElement<any, string | React.JSXElementConstructor<any>>>(t: Text<C>): C {
	return t[1]
}
