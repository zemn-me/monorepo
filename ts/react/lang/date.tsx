...
export const Date = memo(function DateComponent(props: DateProps) {
	...
	return (
		<time className={props.className} dateTime={props.date.toString()} lang={locale.toString()}>
			{content}
		</time>
	);
});
...
export const MonthYear = memo(function MonthYearComponent(props: DateProps) {
	...
	return (
		<time className={props.className} dateTime={props.date.toString()} lang={locale.toString()}>{text}</time>
	);
});
...
export const PrettyDateTime = memo(function PrettyDateTime(props: PrettyDateTimeProps) {
	...
	const follower = localTz != props.date.timeZoneId
