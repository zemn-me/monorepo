...
// please also inject the following environment variables:
// WEB_TEST_BASE_DIR -> the base directory assumed to be the root of the static website
// WEB_TEST_ROOTS -> a comma separated list of paths relative to the base directory to load
