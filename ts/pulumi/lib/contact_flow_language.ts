...
/**
 * Invoke a Lambda function from the flow language.
 * 
 * For some reason (none of which can, I think, be justifiable or valid), AWS
 * does not have any documentation on how to invoke a lambda in the language
 * itsef.
 *
 * I have extracted this example via the UI to use as reference.
 * ``` JSON
 * {
 "Actions": [
    {
      "Parameters": { "LambdaFunctionARN": "$.SystemEndpoint.Address",
        "InvocationTimeLimitSeconds": "3", "ResponseValidation": {
        "ResponseType": "STRING_MAP"
        }
      },
      "Identifier": "2cad4f82-34bd-47a7-b4cc-06f65309f973", "Type":
      "InvokeLambdaFunction", "Transitions": { "NextAction": "", "Errors": [
          {
            "NextAction": "",
