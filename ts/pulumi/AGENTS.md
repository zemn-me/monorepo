...
For `itzg/minecraft-server`, do not pair the default/latest Minecraft version with a stale Java-numbered image tag; use the matching latest image or pin both version and runtime together.
