...
describe('pulumi', () => {
	...
	test('smoke', async () => {
		...
		expect(minecraftService?.inputs['name']).toBe(
			'zemn-me-minecraft-production-service'
		);
		...
		expect(minecraftWakeFunction?.inputs['name']).toBe(
			'zemn-me-minecraft-production-wake'
		);
