...
def ts_project(name, visibility = None, deps = [], ignores_lint = [], data = None, resolve_json_module = True, srcs = None, tsconfig = "//:tsconfig", preserve_jsx = None, tags = [], **kwargs):
    if srcs == None:
