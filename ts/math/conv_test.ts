import { Quaternion as Q, Cartestian as C, Euler as E } from './conv'; 
...
describe('Conversions', () => {
  test('Quaternion from EulerAngles', () => {
    const eulerAngles = new euler_angle.EulerAngle(Math.PI / 4, Math.PI / 4, Math.PI / 4);
    const q = Q.fromEulerAngles(eulerAngles);

    const expectedQ = new quaternion.Quaternion(0.6532814824381883, 0.27059805007309856, 0.27059805007309856, 0.6532814824381883);
  ...
  test('EulerAngle from Quaternion', () => {
    const q = new quaternion.Quaternion(0.6532814824381883, 0.27059805007309856, 0.27059805007309856, 0.6532814824381883);
    const eulerAngles = E.fromQuaternion(q);

    const expectedEulerAngles = new euler_angle.EulerAngle(Math.PI / 4, Math.PI / 4, Math.PI / 4);
