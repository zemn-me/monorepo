...
import { cross, dot, magnitude, normalise, sub } from '#root/ts/math/deprecated/matrix.js';
...
export function lookAt(
	...
	return and_then_flatten(qF, forwardRotation =>
		and_then_flatten(
					...
					return and_then_flatten(
						...
						qRoll =>
							Quaternion.normalize(
								Quaternion.multiply(qRoll, forwardRotation)
							)
					);
				}
