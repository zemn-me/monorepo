...
it('should be able to annotate a successful build', async () => {
  ...
  //bin/host/ffmpeg:smoke                                                  FAILED in 0.1s`)
      ...
      INFO: Build completed, 1 test FAILED, 8634 total actions
::notice title=//%3Avalidate_renovate_config_test passed in 5.1s,file=/BUILD.bazel::  //:validate_renovate_config_test                                         PASSED in 5.1s
::notice title=//.github%3Avalidation passed in 0.5s,file=.github/BUILD.bazel::  //.github:validation                                                     PASSED in 0.5s
