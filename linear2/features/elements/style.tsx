...
export const Style:
    (props: { children: React.ReactElement<{ className?: string }> }) => React.ReactElement
=
    ({ children }) => {
        ...
        return <AmbientClass.Provider value={true}>
...
export const text: (props: { value: string }) => React.ReactElement = ({ value }) => {
    const hasAmbientClass = React.useContext(AmbientClass);
