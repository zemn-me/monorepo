...
export const Li = React.forwardRef<HTMLLIElement, Omit<PropsOf<'li'>, 'ref'>>(
    ({ className, children, ...props}, ref) => <li {...{
        ref,
        ...props
    }}>
        <span {...{
...
export const Ol = React.forwardRef<HTMLOListElement, Omit<PropsOf<'ol'>, 'ref'>>(
...
export const Ul = React.forwardRef<HTMLOListElement, Omit<PropsOf<'ul'>, 'ref'>>(
