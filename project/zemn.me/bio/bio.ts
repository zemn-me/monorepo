...
export const Bio = {
	...
	timeline: [
		...
		},
		{
			...
			tags: [software, security, work, employment],
			description: en`Built out OpenAI's first Secure Development Lifecycle (SDLC); designed security primitives for many OAI products including ChatGPT Canvas and Apple Intelligence. Work on Prompt Injection, Agentic Security & AI cyber risk.`,
			employer: en`OpenAI`
		},
		{
