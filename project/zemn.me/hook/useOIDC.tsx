...
import { InvalidCallbackMessageError, useWindowCallback } from "#root/project/zemn.me/hook/useWindowCallback.js";
...
import { and_then as option_and_then, flatten as option_flatten, None, result_to_option, Some, unwrap_or as option_unwrap_or } from "#root/ts/option/types.js";
import { and_then as result_and_then, Err, flatten as result_flatten, Ok, result_collect, unwrap_or_else as result_unwrap_or_else } from "#root/ts/result/result.js";
