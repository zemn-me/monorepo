...
import { coincide_then, error, future, future_and_then, future_flatten_then, future_promise_collapse_3, loading, resolve } from '#root/ts/future/future.js';
...
export function useOIDC(issuer: string, params: OIDCImplicitRequest): useOIDCReturnType {
	...
	const callbackQuery = useQueryFuture_flatten(useQuery({
