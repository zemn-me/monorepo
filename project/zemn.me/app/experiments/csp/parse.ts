import { BaseUriDirective, Directive, DirectiveName, FetchDirectiveName, FormActionDirective, HashAlgorithm, HashSource, Host, HostSource, KeywordSource, NoncePrefix, NonceSource, OtherDirectiveName, Path, Port, Scheme, SchemeSource, WorkerSrcDirective } from "#root/project/zemn.me/app/experiments/csp/ast.js";
import { z } from "zod";
...
]).transform(([name, value]) => ({ name, value })).pipe(Directive);
