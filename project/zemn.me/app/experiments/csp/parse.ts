...
import { BaseUriDirective, Directive, ExternalDirective, FetchDirectiveName, FormActionDirective, FrameAncestorsDirective, HashAlgorithm, HashSource, Host, HostSource, KeywordSource, NavigationDirective, NoncePrefix, NonceSource, OtherDirectiveName, Path, Port, ReportingDirective, ReportToDirective, ReportUriDirective, SandboxDirective, Scheme, SchemeSource, UriReference, WebRtcDirective, Wildcard, WorkerSrcDirective } from "#root/project/zemn.me/app/experiments/csp/ast.js";
