import { SerializedHostSource, SerializedPolicy, SerializedSourceList } from "#root/project/zemn.me/app/experiments/csp/parse.js"
...
it('should parse a report-uri directive', () => {
	expect(SerializedPolicy.safeParse(
		"report-to chatgpt-csp; report-uri " +
...
it('should parse a frame-ancestors directive', () => {
	expect(SerializedPolicy.safeParse("frame-ancestors chrome-extension://iaiigpefkbhgjcmcmffmfkpmhemdhdnj")).toEqual({
   "data": [
     {
       ...
       "value": [
         {
           ...
           "host": {
             "hostnameParts": [
               "iaiigpefkbhgjcmcmffmfkpmhemdhdnj",
             ],
             "trailingDot": false,
             "wildcardPrefix": false,
           },
...
it('should parse a source list', () => {
	expect(SerializedSourceList.safeParse(`* 'self' data: https: https://docs.google.com https://drive-thirdparty.googleusercontent.com https://ssl.gstatic.com`).success).toEqual(true);
})

it('should parse an img-src directive', () => {
	expect(SerializedPolicy.safeParse("img-src * 'self' data: https: https://docs.google.com https://drive-thirdparty.googleusercontent.com " +
		"https://ssl.gstatic.com")).toEqual({
			success: true
	})
})
...
it.skip('should parse a complex CSP', () => {
