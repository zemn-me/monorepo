...
import { cache, ChangeEvent, useCallback, useEffect, useMemo, useState } from "react";
import { RecordingSettingsContextImpl } from "twilio/lib/rest/video/v1/recordingSettings";
import { z } from "zod";
...
import { oidcAuthorizeUri, watch_out_i_am_verifying_the_id_token_with_no_specified_issuer } from "#root/ts/jose/oidc/oidc.js";
import { LensGet, LensSet } from "#root/ts/lens.js";
import { and, and_then as option_and_then, None, ok_or_else, Option, option_promise_transpose, Some, unwrap_or as option_unwrap_or, unwrap_or as option_unwrap_or, unwrap_or_else as option_unwrap_or_else, zip as option_zip } from "#root/ts/option/types.js";
import { and_then as result_and_then, Err, flatten as result_flatten, Ok, Result, result_promise_transpose, unwrap_or as result_unwrap_or, unwrap_or_else as result_unwrap_or_else, zip as result_zip } from "#root/ts/result_types.js";
...
export default function Auth() {
	...
	const amendment = result_and_then(
		...
		([c, tc]) => void LensSet(AuthorizationCache)(tc as any, c)
	);
