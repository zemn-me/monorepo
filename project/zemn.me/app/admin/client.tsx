...
export default function Admin() {
	const [id_token, request_id_token] = useOIDC();




	const loginA = option_and_then(
		request_id_token,
		r => result_and_then(
			r,
			onClick => <div>
	...
	// this is returning a function instead of unwrapping properly
	// and idk why
	return option_unwrap_or(option_and_then(
		main,
		r => result_unwrap_or(
			r,
			login
