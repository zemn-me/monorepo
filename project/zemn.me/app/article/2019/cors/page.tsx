...
'use client';
import { default as Content, frontmatter as metadata } from '#root/mdx/article/2019/cors';
import style from '#root/project/zemn.me/app/article/2019/cors/style.module.css';
