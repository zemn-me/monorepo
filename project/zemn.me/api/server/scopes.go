...
// toOAuthScopes converts a slice of scope strings to the generated enum type.
func toOAuthScopes(scopes []string) []OAuthScope {
	out := make([]OAuthScope, len(scopes))
...
// toOAuthScopesPtr converts a slice of scope strings to a pointer slice
// matching the generated optional field type.
func toOAuthScopesPtr(scopes []string) *[]OAuthScope {
	converted := toOAuthScopes(scopes)
	return &converted
}
