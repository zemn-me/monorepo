...
function Month({month, events}: { month: string, events: Iterable<Bio.Event>}) {
    return <div className={style.month}> { /* sorry this element is going to be super broken
until you put stuff on the grid ... gotta go for dinner! */ }
        <header className={style.month} lang="en-GB"> { /* <- this needs to be set to the correct language */ }
        {month}
        </header>
