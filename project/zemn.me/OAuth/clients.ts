...
const testClientId = process.env.NEXT_PUBLIC_ZEMN_TEST_OIDC_CLIENT_ID ?? "integration-test-client";
const testName = process.env.NEXT_PUBLIC_ZEMN_TEST_OIDC_NAME ?? "Test Identity Provider";
