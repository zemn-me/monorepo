...
function usage(): string {
	return [
		...
		'run-openai options: --models=a,b, --model-regex=regex, --efforts=all|none,minimal,low,medium,high,xhigh, --question-ids=id,id, --limit-models=N, --limit-questions=N, --max-combinations=N, --concurrency=N, --timeout-ms=N, --resume, --retry-transient, --retry-errors=text,text, --dry-run.',
