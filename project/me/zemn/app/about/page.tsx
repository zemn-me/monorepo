...
import style from '#root/project/me/zemn/app/about/page.module.css';
...
export const metadata: Metadata = {
	title: 'About',
	description: 'The design and history of this website.',
};
...
export default function About() {
	return (
		<section>
			...
			<Prose lang="en-GB">
				<h2 id="website_design">The design of this website.</h2>
				<p>
