...
function TogglableSection() {
	...
	return (
		<Section>
			...
			<p>
				Thanks to portals, when it is removed, it will also be removed
				from the table of contents!
			</p>
			{sectionVisible ? (
				<Section>
					<H3>The Section in Question</H3>
					<p>Click the button in the parent section to remove me!</p>
				</Section>
			) : null}
		</Section>
	);
	...
	return (
		<Article>
			<Section>
				...
				<p>
					This article layout should generate a nice table of
					contents! using portals!
				</p>

				<Section>
					<H2>How it Works</H2>
					<p>
						Every Section gets its own portal, and every section
						header adds an element to that portal.
					</p>
				</Section>
