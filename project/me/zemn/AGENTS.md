...
- Selenium itests use the Vite dev server; keep `vite.config.ts` `optimizeDeps.entries` broad enough to avoid first-visit full reloads for lazy route dependencies.
