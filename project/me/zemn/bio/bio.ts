...
export const Bio = {
	...
	timeline: [
		...
		},
		{
			...
			title: en`Beyond Prompt Injection: Agentic AI Attacks in the Real World`,
			publisher: en`DEF CON Singapore`,
		...
		},
		{
			...
			publisher: en`GitHub Security Advisory`,
		...
		},
		{
			...
			publisher: en`Young Rewired State`,
		...
		},
		{
			...
			title: en`HackFortress Champions`,
			publisher: en`ShmooCon`,
			tags: [accolade, security, gaming],
			description: en`Defended title for hybrid gaming CTF / esports competition.`,
		},
		{
		...
		},
		{
			...
			publisher: en`De Nieuwe Reporter`,
		...
		},
		{
			...
			publisher: en`Valve Corporation`,
		...
		},
		{
			...
			description: en`Article on an Übersicht form-post bug that let any website control users’ computers, and using Spotify's certificate design to explain why localhost web services are a weak application-security boundary.`,
			priority: 7,
			tags: [security, disclosure],
		...
		},
		{
			...
			description: en`Code execution vulnerability in website for TV show “Mr. Robot”.`,
			priority: 6,
		...
		},
		{
			...
			description: en`Vulnerability in php-openid allowing an attacker to log in as any user.`,
			priority: 6,
			tags: [security, writing, disclosure],
		...
		},
		{
			...
			description: en`Remote code execution in website for TV show “Mr. Robot” allowing attacker to control the website server.`,
			priority: 7,
			tags: [security, disclosure, comment],
		...
		},
		{
			...
			title: en`7th place Cambridge Chemistry Challenge (C₃L₆)`,
			publisher: en`University of Cambridge`,
		},
		{
			...
			priority: 5,
			tags: [science, accolade],
			title: en`5th place, Cambridge Chemistry Challenge (C₃L₆)`,
			publisher: en`University of Cambridge`,
		},
		{
		...
		},
		{
			...
			description: en`Padding oracle based attack allowing full decryption of traffic on Steam, the world’s largest gaming platform.`,
			priority: 7,
			tags: [security, gaming, disclosure, comment],
			title: en`Steam Patches Broken Crypto in Wake of Replay, Padding Oracle Attacks`,
			publisher: en`Threatpost`,
		...
		},
		{
			...
			date: date(7, 'jan', 2019),
			description: en`Technical writeup & disclosure of a 1-click attack on the Steam, the world’s largest gaming platform, allowing remote access to users’ computers.`,
			tags: [security, writing, disclosure],
		...
		},
		{
			...
			description: en`News coverage of Steam vulnerability allowing remote access to users’ computers.`,
			priority: 7,
			tags: [security, disclosure, comment],
		...
		},
		{
			...
			publisher: en`Infiltrate`,
			description: en`Technical talk at offensive AppSec conference summarising through example research into hybrid web / desktop application security`,
		...
		},
		{
			...
			publisher: en`UK National Cyber Security Centre`,
			priority: 5,
		...
		},
		{
			...
			publisher: en`GitHub Advisory Database`,
		...
		},
		{
			...
			date: date(13, 'jan', 2024),
			title: en`HackFortress Finals`,
			publisher: en`ShmooCon`,
			url: url`https://youtu.be/z-XiVKuQOtc`,
			description: en`Video of the finals of HackFortress at ShmooCon.`,
		},
		{
		...
		},
		{
			...
			title: en`Panel Discussion: How Leading AI Platforms Approach Building Trustworthy Agents`,
			publisher: en`AI Agent Security Summit SF`,
			url: linkToHighlight(
